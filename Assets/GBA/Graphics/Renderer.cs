namespace GarboDev
{
    ...
    public partial class Renderer : IRenderer
    {
        ...
        public void RenderLine(int line)
        {
            ...
            Array.Copy(this.scanline, 0, this.back, this.curLine * (int)Renderer.pitch, (int)Renderer.pitch);
        }
        ...
        public static uint _GbaTo32_(ushort color)
        {
            // more accurate, but slower :(
            // return colorLUT[color];

#if true
            return (uint)color; // hack
#else
